...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst goal_1 = __webpack_require__(/*! ./../goal */ \"./src/js/game/goal.ts\");\r\nconst obstacle_1 = __webpack_require__(/*! ./../obstacles/obstacle */ \"./src/js/game/obstacles/obstacle.ts\");\r\nconst block_1 = __webpack_require__(/*! ./../obstacles/block */ \"./src/js/game/obstacles/block.ts\");\r\nconst staticSprite_1 = __webpack_require__(/*! ./../../graphics/representations/staticSprite */ \"./src/js/graphics/representations/staticSprite.ts\");\r\nconst textBox_1 = __webpack_require__(/*! ./../../graphics/controls/textBox */ \"./src/js/graphics/controls/textBox.ts\");\r\nconst player_1 = __webpack_require__(/*! ./../player */ \"./src/js/game/player.ts\");\r\nconst animation_1 = __webpack_require__(/*! ./../../graphics/representations/animation */ \"./src/js/graphics/representations/animation.ts\");\r\nconst scene_1 = __webpack_require__(/*! ../scene/scene */ \"./src/js/game/scene/scene.ts\");\r\nconst vec2_1 = __webpack_require__(/*! ../../physics/vec2 */ \"./src/js/physics/vec2.ts\");\r\nconst player_2 = __webpack_require__(/*! ../player */ \"./src/js/game/player.ts\");\r\nconst oneShotAnimation_1 = __webpack_require__(/*! ../../graphics/representations/oneShotAnimation */ \"./src/js/graphics/representations/oneShotAnimation.ts\");\r\nclass PlayScene extends scene_1.Scene {\r\n    constructor(document, canvas, resourceManager, sceneManager) {\r\n        const shotsRequests = [];\r\n        const robotSprites = new player_2.PlayerStatesResources(new animation_1.Animation(canvas.context, resourceManager.getResource('run'), 9, 0.3), new animation_1.Animation(canvas.context, resourceManager.getResource('idle'), 9, 0.3), new oneShotAnimation_1.OneShotAnimation(canvas.context, resourceManager.getResource('jump'), 9, 0.3));\r\n        const player = new player_1.Player(new vec2_1.Vec2(0, canvas.height - robotSprites.idling.height), robotSprites, 0, canvas.width, canvas.height, () => sceneManager.setScene('gameover'), () => sceneManager.setScene('win'));\r\n        const blockSprite = new staticSprite_1.StaticSprite(canvas.context, resourceManager.getResource('block'), 0.3);\r\n        const shotAnimation = new staticSprite_1.StaticSprite(canvas.context, resourceManager.getResource('shot'));\r\n        const bombSpriteOne = new animation_1.Animation(canvas.context, resourceManager.getResource('one'), 10);\r\n        const bombSpriteTwo = new animation_1.Animation(canvas.context, resourceManager.getResource('missile_one'), 9);\r\n        const starSprite = new staticSprite_1.StaticSprite(canvas.context, resourceManager.getResource('goal'), 0.3);\r\n        let timeText = new textBox_1.TextControl(canvas.context, new vec2_1.Vec2(0, 5), 300, 70, `Time: 0`, resourceManager.getDrawable('time_background'));\r\n        const blocks = [\r\n            new block_1.Block(new vec2_1.Vec2(400, canvas.height - blockSprite.height - 300), blockSprite),\r\n            new block_1.Block(new vec2_1.Vec2(400 + blockSprite.width, canvas.height - blockSprite.height - 300), blockSprite),\r\n            new block_1.Block(new vec2_1.Vec2(600 + blockSprite.width, canvas.height - blockSprite.height - 500), blockSprite),\r\n            new block_1.Block(new vec2_1.Vec2(700 + blockSprite.width, canvas.height - blockSprite.height - 700), blockSprite),\r\n            new block_1.Block(new vec2_1.Vec2(800 + blockSprite.width, canvas.height - blockSprite.height - 600), blockSprite),\r\n        ];\r\n        const goal = new goal_1.Goal(new vec2_1.Vec2(canvas.width - starSprite.width - 100, canvas.height - starSprite.height - 300), starSprite);\r\n        let bomb1 = new obstacle_1.Bomb(new vec2_1.Vec2(800, canvas.height - blockSprite.height - 300), bombSpriteOne);\r\n        let missile = new obstacle_1.Missile(canvas.width, canvas.height - blockSprite.height - 500, bombSpriteTwo);\r\n        super(document, canvas, resourceManager.getDrawable('menu_background'), [\r\n            player,\r\n            timeText,\r\n            bomb1, missile,\r\n            goal\r\n        ].concat(blocks));\r\n        this.timeText = timeText;\r\n        this.shotsRequests = shotsRequests;\r\n        this.shotAnimation = shotAnimation;\r\n    }\r\n    play(newTime) {\r\n        super.play(newTime);\r\n        this.timeText.changeText(`Time: ${Math.trunc((newTime - this._fistUpdate) / 1000)}`);\r\n    }\r\n}\r\nexports.PlayScene = PlayScene;\r\n\n\n//# sourceURL=webpack:///./src/js/game/gui/playScene.ts?");
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst animation_1 = __webpack_require__(/*! ./../../graphics/representations/animation */ \"./src/js/graphics/representations/animation.ts\");\r\nconst control_1 = __webpack_require__(/*! ./../../graphics/controls/control */ \"./src/js/graphics/controls/control.ts\");\r\nconst textBox_1 = __webpack_require__(/*! ./../../graphics/controls/textBox */ \"./src/js/graphics/controls/textBox.ts\");\r\nconst staticSprite_1 = __webpack_require__(/*! ./../../graphics/representations/staticSprite */ \"./src/js/graphics/representations/staticSprite.ts\");\r\nconst button_1 = __webpack_require__(/*! ./../../graphics/controls/button */ \"./src/js/graphics/controls/button.ts\");\r\nconst scene_1 = __webpack_require__(/*! ./../scene/scene */ \"./src/js/game/scene/scene.ts\");\r\nconst vec2_1 = __webpack_require__(/*! ../../physics/vec2 */ \"./src/js/physics/vec2.ts\");\r\nclass WinScene extends scene_1.Scene {\r\n    constructor(document, canvas, resourceManager, sceneManager) {\r\n        let buttonResource = {\r\n            normal: new staticSprite_1.StaticSprite(canvas.context, resourceManager.getResource('menu_button_1')),\r\n            pressed: new staticSprite_1.StaticSprite(canvas.context, resourceManager.getResource('menu_button_2'))\r\n        };\r\n        let replayButton = new button_1.TwoWayButton(new vec2_1.Vec2((canvas.width - buttonResource.normal.width) * 0.5, (canvas.height - buttonResource.normal.height) * 0.5 - 300), buttonResource, () => {\r\n            sceneManager.setScene('start');\r\n        });\r\n        let robotSprite = new animation_1.Animation(canvas.context, resourceManager.getResource('idle'), 9, 1.2, 0.3);\r\n        let deadRobot = new control_1.DrawableControl(new vec2_1.Vec2(canvas.width - robotSprite.width, canvas.height - robotSprite.height), robotSprite);\r\n        let textboxWidth = 500;\r\n        let textboxHeight = 400;\r\n        const starSprite = new staticSprite_1.StaticSprite(canvas.context, resourceManager.getResource('goal'), 0.3);\r\n        super(document, canvas, resourceManager.getDrawable('menu_background'), [\r\n            replayButton,\r\n            deadRobot,\r\n            new textBox_1.TextControl(canvas.context, new vec2_1.Vec2((canvas.width - textboxWidth) * 0.5, (canvas.height - textboxHeight) * 0.5), textboxWidth, textboxHeight, 'You Win!')\r\n        ]);\r\n        this._robotAnimation = robotSprite;\r\n    }\r\n    finalize() {\r\n        super.finalize();\r\n        this._robotAnimation.reset();\r\n    }\r\n}\r\nexports.WinScene = WinScene;\r\n\n\n//# sourceURL=webpack:///./src/js/game/gui/winScene.ts?");
