...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst button_1 = __webpack_require__(/*! ./../../graphics/controls/button */ \"./src/js/graphics/controls/button.ts\");\r\nconst container_1 = __webpack_require__(/*! ./../../graphics/controls/container */ \"./src/js/graphics/controls/container.ts\");\r\nconst scene_1 = __webpack_require__(/*! ./../scene/scene */ \"./src/js/game/scene/scene.ts\");\r\nconst vec2_1 = __webpack_require__(/*! ../../physics/vec2 */ \"./src/js/physics/vec2.ts\");\r\nconst staticSprite_1 = __webpack_require__(/*! ../../graphics/representations/staticSprite */ \"./src/js/graphics/representations/staticSprite.ts\");\r\nclass EditorScene extends scene_1.Scene {\r\n    constructor(document, canvas, resourceManager) {\r\n        const menu = new container_1.MenuControl(new vec2_1.Vec2(canvas.width - EditorScene._menuWidth, 0), EditorScene._menuWidth, canvas.height, resourceManager, [\r\n            new button_1.TwoWayButton(vec2_1.Vec2.Zero(), {\r\n                normal: new staticSprite_1.StaticSprite(resourceManager.getResource('play_button_1')),\r\n                pressed: new staticSprite_1.StaticSprite(resourceManager.getResource('play_button_2'))\r\n            }, () => alert('pressed')),\r\n            new button_1.TwoWayButton(vec2_1.Vec2.Zero(), {\r\n                normal: new staticSprite_1.StaticSprite(resourceManager.getResource('play_button_1')),\r\n                pressed: new staticSprite_1.StaticSprite(resourceManager.getResource('play_button_2'))\r\n            }, () => alert('pressed'))\r\n        ]);\r\n        super(document, canvas, resourceManager.getDrawable('menu_background'), [\r\n            menu\r\n        ]);\r\n        this.selectedObject = null;\r\n    }\r\n}\r\nexports.EditorScene = EditorScene;\r\nEditorScene._menuWidth = 300;\r\n\n\n//# sourceURL=webpack:///./src/js/game/gui/editorScene.ts?");
...
/***/ "./src/js/graphics/controls/container.ts":
/*!***********************************************!*\
  !*** ./src/js/graphics/controls/container.ts ***!
  \***********************************************/
/*! no static exports found */
